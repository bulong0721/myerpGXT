 ...
 */
@Entity
@Table(name="pp_order_node_trl")
@IdClass(org.adempiere.model.PPOrderNodeTrlPK.class)
public class PPOrderNodeTrl extends org.adempiere.common.ADEntityBase {
	...
	public PPOrderNodeTrl() {
	}

	public PPOrderNodeTrl(String aDLanguage, Integer pPOrderNodeID) {
