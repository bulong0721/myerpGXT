 ...
 */
@Entity
@Table(name="ad_treenodecmc")
@IdClass(org.adempiere.model.AdTreenodecmcPK.class)
public class AdTreenodecmc extends org.adempiere.common.ADEntityBase {
	...
	public AdTreenodecmc() {
	}

	public AdTreenodecmc(Integer adTreeId, Integer nodeId) {
