 ...
 */
@Entity
@Table(name = "ad_process_vt")
public class ADProcessVt extends org.adempiere.common.ADEntityBase {
	...
	private List<ADProcessParaVt>	aDProcessParaVts;
	...
	@OneToMany(mappedBy="processVt")
	public List<ADProcessParaVt> getADProcessParaVts() {
		return this.aDProcessParaVts;
	}

	public void setADProcessParaVts(List<ADProcessParaVt> adProcessParaVts) {
		this.aDProcessParaVts = adProcessParaVts;
	}

	public ADProcessParaVt addADProcessParaVt(ADProcessParaVt adProcessParaVt) {
		getADProcessParaVts().add(adProcessParaVt);
		adProcessParaVt.setProcessVt(this);

		return adProcessParaVt;
	}

	public ADProcessParaVt removeAdProcessParaVt(ADProcessParaVt adProcessParaVt) {
		getADProcessParaVts().remove(adProcessParaVt);
		adProcessParaVt.setProcessVt(null);
