...
public class CmTemplatetable extends org.adempiere.common.ADEntityBase {
	...
	public CmTemplatetable() {
	}

	public CmTemplatetable(Integer cmTemplatetableId) {
	...
	@Basic
	@Column(name="CM_TEMPLATE_ID", columnDefinition="INT", nullable=false)
