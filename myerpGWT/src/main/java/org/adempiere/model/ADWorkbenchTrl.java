 ...
 */
@Entity
@Table(name="ad_workbench_trl")
@IdClass(org.adempiere.model.ADWorkbenchTrlPK.class)
public class ADWorkbenchTrl extends org.adempiere.common.ADEntityBase {
	...
	public ADWorkbenchTrl() {
	}

	public ADWorkbenchTrl(String aDLanguage, Integer aDWorkbenchID) {
