 ...
 */
@Entity
@Table(name="pp_order_bom_trl")
@IdClass(org.adempiere.model.PPOrderBOMTrlPK.class)
public class PPOrderBOMTrl extends org.adempiere.common.ADEntityBase {
	...
	public PPOrderBOMTrl() {
	}

	public PPOrderBOMTrl(String aDLanguage, Integer pPOrderBOMID) {
