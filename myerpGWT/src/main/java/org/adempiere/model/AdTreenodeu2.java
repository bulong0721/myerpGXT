 ...
 */
@Entity
@Table(name="ad_treenodeu2")
@IdClass(org.adempiere.model.AdTreenodeu2PK.class)
public class AdTreenodeu2 extends org.adempiere.common.ADEntityBase {
	...
	public AdTreenodeu2(Integer adTreeId, Integer nodeId) {
