...
public class AdInfowindow extends org.adempiere.common.ADEntityBase {
	...
	@TableGenerator(name = "PkGen_1281", table = "ad_sequence", pkColumnName = "name", pkColumnValue = "AD_InfoWindow", valueColumnName = "currentnextsys", allocationSize = 1 )
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "PkGen_1281")
