 ...
 */
@Entity
@Table(name="ad_infocolumn_trl")
@IdClass(org.adempiere.model.ADInfoColumnTrlPK.class)
public class ADInfoColumnTrl extends org.adempiere.common.ADEntityBase {
	...
	public ADInfoColumnTrl() {
	}

	public ADInfoColumnTrl(Integer aDInfoColumnID, String aDLanguage) {
