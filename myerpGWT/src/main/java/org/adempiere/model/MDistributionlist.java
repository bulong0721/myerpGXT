 ...
 */
@Entity
@Table(name="m_distributionlist")
public class MDistributionlist extends org.adempiere.common.ADEntityBase {
	...
	public MDistributionlist() {
	}

	public MDistributionlist(Integer mDistributionlistId) {
