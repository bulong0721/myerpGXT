 ...
 */
@Entity
@Table(name="i_fajournal")
public class IFAJournal extends org.adempiere.common.ADEntityBase {
	...
	public IFAJournal(Integer iFAJournalID) {
		this.iFAJournalID = iFAJournalID;
	}
	...
	@Basic
	@Column(name="A_ENTRY_TYPE", length=3)
	...
	@Basic
	@Column(name="ISDEPRECIATED", length=1)
	...
	public void setIFAJournalID(Integer iFAJournalID) {
		this.iFAJournalID = iFAJournalID;
	}
