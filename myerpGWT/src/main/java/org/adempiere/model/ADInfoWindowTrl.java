 ...
 */
@Entity
@Table(name="ad_infowindow_trl")
@IdClass(org.adempiere.model.ADInfoWindowTrlPK.class)
public class ADInfoWindowTrl extends org.adempiere.common.ADEntityBase {
	...
	public ADInfoWindowTrl() {
	}

	public ADInfoWindowTrl(Integer aDInfoWindowID, String aDLanguage) {
