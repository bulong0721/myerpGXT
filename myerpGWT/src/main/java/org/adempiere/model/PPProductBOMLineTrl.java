 ...
 */
@Entity
@Table(name="pp_product_bomline_trl")
@IdClass(org.adempiere.model.PPProductBOMLineTrlPK.class)
public class PPProductBOMLineTrl extends org.adempiere.common.ADEntityBase {
	...
	public PPProductBOMLineTrl() {
	}

	public PPProductBOMLineTrl(String aDLanguage, Integer pPProductBOMLineID) {
