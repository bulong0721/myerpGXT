 ...
 */
@Entity
@Table(name="c_charge_trl")
@IdClass(org.adempiere.model.CChargeTrlPK.class)
public class CChargeTrl extends org.adempiere.common.ADEntityBase {
	...
	public CChargeTrl(String aDLanguage, Integer cChargeID) {
