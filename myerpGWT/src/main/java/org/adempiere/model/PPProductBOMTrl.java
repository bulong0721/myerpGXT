 ...
 */
@Entity
@Table(name="pp_product_bom_trl")
@IdClass(org.adempiere.model.PPProductBOMTrlPK.class)
public class PPProductBOMTrl extends org.adempiere.common.ADEntityBase {
	...
	public PPProductBOMTrl() {
	}

	public PPProductBOMTrl(String aDLanguage, Integer pPProductBOMID) {
