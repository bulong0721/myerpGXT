...
public class MSerNoCtlExclude extends org.adempiere.common.ADEntityBase {
	...
	@Id
	@Column(name="M_SERNOCTLEXCLUDE_ID", columnDefinition="INT")
	@TableGenerator(name = "PkGen_1171", table = "ad_sequence", pkColumnName = "name", pkColumnValue = "M_SerNoCtlExclude", valueColumnName = "currentnextsys", allocationSize = 1 )
	@GeneratedValue(strategy = GenerationType.TABLE, generator = "PkGen_1171")
	...
	@Basic
	@Column(name="M_SERNOCTL_ID", columnDefinition="INT", nullable=false)
