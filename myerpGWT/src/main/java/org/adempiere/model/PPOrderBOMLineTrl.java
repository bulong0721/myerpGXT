 ...
 */
@Entity
@Table(name="pp_order_bomline_trl")
@IdClass(org.adempiere.model.PPOrderBOMLineTrlPK.class)
public class PPOrderBOMLineTrl extends org.adempiere.common.ADEntityBase {
	...
	public PPOrderBOMLineTrl() {
	}

	public PPOrderBOMLineTrl(String aDLanguage, Integer pPOrderBOMLineID) {
