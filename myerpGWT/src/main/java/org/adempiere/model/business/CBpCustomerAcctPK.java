...
/**
 * The primary key class for the c_bp_customer_acct database table.
 * 
 */
@Embeddable
public class CBpCustomerAcctPK implements Serializable {
	//default serial version id, required for serializable classes.
	private static final long serialVersionUID = 1L;
	private long cBpartnerId;
	private long cAcctschemaId;

	public CBpCustomerAcctPK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof CBpCustomerAcctPK)) {
			return false;
		}
		CBpCustomerAcctPK castOther = (CBpCustomerAcctPK)other;
		return 
