...
//	 * @param columnMaxWidth array with column max width - 0=no restrictions -
//	 *            negative=supress if null
//	 * @param columnMaxHeight array with row max height for a column - 0=no
...
//					dataSizes[row][col].addBelow(new Dimension((int) ((BarcodeElement) dataItem).getWidth(),
...
//						log.finest("Same Width - Col=" + col + " - OrigWidth=" + origWidth + " - Width=" + colWidth
//								+ " - Total=" + p_width);
//					} else {
//						m_columnWidths.set(col, new Float(colWidth));
//						p_width += (colWidth - origWidth.floatValue());
//						log.finest("New Width - Col=" + col + " - OrigWidth=" + origWidth + " - Width=" + colWidth
//								+ " - Total=" + p_width);
//					}
//				}
//			}
...
//						log.finest("- Split (leave on current) Row=" + dataRow + " - Available=" + availableHeight
//								+ ", RowHeight=" + rowHeight);
//						// if (splitRow (dataRow))
//						// addlRows += 1;
//					}
...
//					}
//					log.finest("Page Y=" + m_firstRowOnPage.size() + " - Row=" + dataRow + " - force="
//							+ isPageBreak(dataRow));
//					firstPage = false;
//					//
...
//					log.finest("- Split (move to next) Row=" + dataRow + " - Available=" + availableHeight
//							+ ", RowHeight=" + rowHeight);
//
//				}
//				log.finest("Page Y=" + m_pageHeight.size() + ", Row=" + dataRow + ",AddlRows=" + addlRows + ", Height="
//						+ rowHeight + " - Available=" + availableHeight + ", Used=" + usedHeight);
//			} // for all rows
//			m_pageHeight.add(new Float(usedHeight)); // Y index only
//			log.finest("Page Y=" + m_pageHeight.size() + " - PageHeight=" + usedHeight);
//		} // multiple Y | pages
...
//		} // multiple - X pages
//
//		log.fine("Pages=" + getPageCount() + " X=" + m_firstColumnOnPage.size() + "/Y=" + m_firstRowOnPage.size()
...
//		log.fine("PageCount - Table=" + getPageCount() + "(Start=" + m_pageNoStart + ") Layout=" + lastLayoutPage
//				+ " - Old Height=" + p_height);
...
//		log.fine("Page=" + pageNo + " - PageIndex=" + pageIndex + ", PageYindex=" + pageYindex + ", Height="
...
//			nextPageRow = ((Integer) m_firstRowOnPage.get(pageYindex + 1)).intValue();
//		if (DEBUG_PRINT)
//			log.finest("Col=" + firstColumn + "-" + (nextPageColumn - 1) + ", Row=" + firstRow + "-"
//					+ (nextPageRow - 1));
//
//		// Top Left
...
//
//		if (DEBUG_PRINT)
//			log.finer("#" + col + " - x=" + curX + ", y=" + curY + ", width=" + colWidth + "/" + netWidth
//					+ ", HeaderHeight=" + rowHeight + "/" + netHeight);
...
//						|| (alignment.equals(MPrintFormatItem.FIELDALIGNMENTTYPE_LeadingLeft) && !layout
//								.isLeftToRight()))
...
//										if (alignment.equals(MPrintFormatItem.FIELDALIGNMENTTYPE_Center))
//											penX += (netWidth - layout.getAdvance()) / 2;
//										else if ((alignment.equals(MPrintFormatItem.FIELDALIGNMENTTYPE_TrailingRight) && layout
//												.isLeftToRight())
//												|| (alignment.equals(MPrintFormatItem.FIELDALIGNMENTTYPE_LeadingLeft) && !layout
//														.isLeftToRight()))
//											penX += netWidth - layout.getAdvance();
...
//																			// text
//										if (DEBUG_PRINT)
//											log.fine("row=" + row + ",col=" + col + " - " + str + " - x=" + penX
//													+ ",y=" + penY);
...
//		log.finest("row=" + row + ", col=" + col + " - Rows=" + m_printRows.size() + ", Cols=" + columns.size() + " - "
//				+ data);
//	} // addAdditionalLines
//
//	/** Print Data */
