...
import org.adempiere.model.core.AdImage;
...
public class ImageElement extends PrintElement {
	...
	private void loadFromDB(int record_ID) {
		AdImage mimage = POUtil.find(AdImage.class, record_ID);
		if (mimage == null) {
			return;
		}
	...
	public void paint(Graphics2D g2D, int pageNo, Point2D pageStart, Properties ctx, boolean isView) {
		...
		if (AdPrintformatitem.FIELDALIGNMENTTYPE_TrailingRight.equals(fieldAlignmentType))
