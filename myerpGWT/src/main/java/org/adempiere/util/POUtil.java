...
public final class POUtil {
    ...
    public static List<IdentifierColumn> queryIdColumnsByTable(PersistContext pCtx, String table) {
        ...
        List<IdentifierColumn> resultList = selectListByNamedQuery(pCtx, "queryIdColumnsByTable",
                                                                   IdentifierColumn.class, paramMap);
        return resultList;
    }
    ...
    public static <T extends ADTreeNode> List<T> queryRootNodes(PersistContext pCtx, Class<T> clazz, int adTreeId,
                                                                int adUserId) {
    ...
    public static ADProcessVt queryProcessTrlWithParamsByProcessId(PersistContext pCtx, Integer processId,
                                                                   int languageId) {
        Map<String, Object> paramMap = toMap("aDProcessId", processId);
        paramMap.put("aDLanguageID", languageId);
    ...
    public static void removeAll(PersistContext pCtx, List<?> list) throws Exception {
        try {
            EntityManager em = pCtx.begin();
            for (Object entity : list) {
