...
import org.adempiere.web.client.component.LookupField;
...
public class LoginView extends BaseReverseView<ILoginPresenter> implements ILoginView, ConfirmToolListener {
    ...
    @UiField(provided = true)
    LookupField<LookupValue> lookupCombo;
    @UiField(provided = true)
    ...
    private void initWidgets() {
        ...
        ListStore<LookupValue> lookupStore = CommonUtil.createDataSource();
        lookupCombo = new LookupField<LookupValue>(lookupStore, labelProvider);
    }
    ...
    public void validateLogged() {
        ...
        adempiereService.getADUserContext(callback);
    }
