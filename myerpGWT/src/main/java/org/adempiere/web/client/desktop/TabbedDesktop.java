...
public class TabbedDesktop implements IDesktop {
    ...
    private HasStatusBar          statusBar;
    ...
    public HasStatusBar getStatusBar() {
        return statusBar;
    }

    public void setStatusBar(HasStatusBar statusBar) {
        ...
        AsyncCallback<FormModel> callback = new AsyncSuccessCallback<FormModel>() {
            ...
            public void onSuccess(FormModel model) {
                ...
                if (null != form) {
                    ...
                    WidgetUtil.setStatusLine("ClassNotFound:" + modelClass, true);
                }
            }
        };
    ...
    @Override
    public void setMajorStatusHtml(String html) {
        if (null != statusBar) {
            statusBar.getMajorLabel().setHTML(html);
        }
    }

    @Override
    public void setMinorStatusHtml(String html) {
        if (null != statusBar) {
            statusBar.getMinorLabel().setHTML(html);
        }
    }
