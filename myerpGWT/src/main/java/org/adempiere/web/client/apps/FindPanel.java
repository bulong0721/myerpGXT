...
public class FindPanel extends ModalDialog implements ConfirmToolListener {
    ...
    private void initWidget(final TabModel tabModel) {
        ...
        ColumnConfig<ADExpression, FieldOperator> operatorColumn = new ColumnConfig<ADExpression, FieldOperator>(
                                                                                                                 new XValueProvider<FieldOperator>(
                                                                                                                                                   "fieldOperator"));
        operatorColumn.setHeader(i18n.findPanel_ColOperator());
        final ColumnConfig<ADExpression, ?> value1Column = new ColumnConfig<ADExpression, Object>(
                                                                                                  new XValueProvider<Object>(
                                                                                                                             "value1"));
        value1Column.setHeader(i18n.findPanel_ColValue1());
        final ColumnConfig<ADExpression, ?> value2Column = new ColumnConfig<ADExpression, Object>(
                                                                                                  new XValueProvider<Object>(
                                                                                                                             "value2"));
    ...
    List<? extends FormField> pickSimpleFields(TabModel tabModel) {
        ...
        if (null != tabModel && null != tabModel.getFieldList()) {
            for (FieldModel fieldModel : tabModel.getFieldList()) {
                if (fieldModel.isIdentifier() || fieldModel.isKey()) {
